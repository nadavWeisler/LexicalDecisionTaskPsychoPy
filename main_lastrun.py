...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\t-nweisler\\Desktop\\Repos\\Else\\LexicalDecisionTaskPsychoPy\\main_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome to the Lexical Decision Task!\n\nIn this task, you will be presented with a series of stimuli. Your job is to decide whether each stimulus is a real word or a non-word.\n\nInstructions:\n- Press left key if the stimulus is a real word.\n- Press right key if the stimulus is a non-word.\n\nPress 'Space' to start the task.",
        font='Open Sans',
